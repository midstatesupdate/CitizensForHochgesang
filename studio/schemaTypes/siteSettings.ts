...
export const siteSettings = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'newsEnabled',
      title: 'News page enabled',
      type: 'boolean',
      group: 'pages',
      initialValue: false,
      description: 'When off, the News page and all article detail pages return a 404 and the nav item is hidden.',
    }),
    defineField({
      name: 'eventsEnabled',
      title: 'Events page enabled',
      type: 'boolean',
      group: 'pages',
      initialValue: false,
      description: 'When off, the Events page and the event details page return a 404 and the nav item is hidden.',
    }),
    defineField({
      name: 'platformEnabled',
      title: 'About & Priorities page enabled',
      type: 'boolean',
      group: 'pages',
      initialValue: false,
      description: 'When off, the About & Priorities page and all priority detail pages return a 404 and the nav item is hidden.',
    }),
    defineField({
      name: 'faqEnabled',
      title: 'FAQ page enabled',
      type: 'boolean',
      group: 'pages',
      initialValue: false,
      description: 'When off, the FAQ page returns a 404 and the nav item is hidden.',
    }),
    defineField({
      name: 'mediaEnabled',
      title: 'Media & Press page enabled',
      type: 'boolean',
      group: 'pages',
      initialValue: false,
      description: 'When off, the Media & Press page returns a 404 and the nav item is hidden.',
    }),
    defineField({
      name: 'supportEnabled',
      title: 'Support page enabled',
      type: 'boolean',
      group: 'pages',
      initialValue: false,
      description: 'When off, the Support page returns a 404 and the nav item is hidden.',
    }),
    defineField({
      name: 'campaignLogo',
      title: 'Campaign Logo',
